...
public class CardDAO {
    ...
    private String[] cols = new String[]{ ID, NAME, BOARD_SHORTLINK, BOARD_NAME, BOARD_ID, CLOCKED_OFF_LIST,
            CLOCKED_OFF_LIST, IS_CLOCKED_OFF, IS_PENDING_PUSH, DEADLINE };
